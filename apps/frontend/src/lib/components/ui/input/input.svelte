...
// Props definition handling both file inputs and standard inputs
...
let {
  ref = $bindable(null),
  value = $bindable(), // Allows bind:value={var}
  type,
  files = $bindable(), // Allows bind:files={var} for file inputs
  class: className,
